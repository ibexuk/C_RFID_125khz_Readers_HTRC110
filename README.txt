...
This project was previously available from our http://www.embedded-code.com source code store and is a fully packaged and documented project.  After several years selling these source code projects to developers we took the decision to finally open source all of the projects hosted on the site.

The projects original page on the embedded-code.com web site, which includes a detailed technical manual can be found at: http://www.embedded-code.com/source-code/rfid/125khz-rfid-readers/htrc110-em4102-rfid-reader-driver
